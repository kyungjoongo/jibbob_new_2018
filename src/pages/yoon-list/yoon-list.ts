...
@Component({
    ...
    template:`
        <ion-header>
            <ion-navbar color="facebook" class="">
                <button ion-button menuToggle>
                    <ion-icon name="menu"></ion-icon>
                </button>
                <ion-title>윤식당 레시피</ion-title>
            </ion-navbar>
        </ion-header>
...
export class YoonListPage {
    ...
    naver_url = "https://checkout002-191623.appspot.com/blog_list?query=윤식당 부탁해 레시피&page=";

    local_naver_url = "http://kyungjoon.ipdisk.co.kr:5000/blog_list?query=윤식당 부탁해 레시피&page=";
